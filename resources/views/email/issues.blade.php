...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;">NEXT MBA Account concerns.</p>
  </div>
...
<p style="font-size: 14px; line-height: 140%;">From: {{ $email }}</p>
<p style="font-size: 14px; line-height: 140%;">Message: {{ $messages }}</p>
  </div>
